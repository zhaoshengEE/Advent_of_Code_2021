...
5. Print out the length of the SET scanners
...
2. Iterate through the beacons of the found scanner:
    1. Iterate through the beacons of the mapped beacons:
        ...
        3. If the intersection between the beacons of found scanner and the beacons is greater than 12:
            1. Append the index of unfound scanner to the found list
            2. Remove the index of unfound scanner from the unfound list
            3. Assign beacons to the corresoonding element in scanners list
            4. Terminate the function
"""
...
found = [0]
unfound = list(range(1, len(scanners)))
...
print(f"The number of beacons is: {len(set.union(*scanners))}")