...
4. Print out the length of the max_ys list
"""
...
if __name__ == "__main__":
    ...
    print(f"The number of initial velocity values cause the probe to be within the target area after any step is: {len(max_ys)}")